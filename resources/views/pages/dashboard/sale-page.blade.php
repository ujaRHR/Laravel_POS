            ...
            <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p>
                            <button onclick="createInvoice()" class="btn  my-3 bg-gradient-danger w-40">Confirm</button>
                        </p>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <label class="form-label">Available Unit</label>
                                <input type="text" class="form-control" id="PUnit" disabled>
...
<script>
    ...
    function add() {
        ...
        else if(parseInt(PQty) > parseInt(PUnit)){
            errorToast("Product Quantity >>> Product Stock");
        }
        else {
            let item = { product_name: PName, id: PId, qty: PQty, sale_price: PTotalPrice };
    ...
    function addModal(id, name, unit, price) {
    ...
    async function CustomerList() {
        ...
        res.data.forEach(function (item, index) {
            let row = `<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-email="${item['email']}" data-phone="${item['mobile']}" data-id="${item['id']}" class="btn btn-outline-dark addCustomer  text-xxs px-2 py-1  btn-sm m-0">Add</a></td>
                     </tr>`
    ...
    async function ProductList() {
        ...
        res.data.forEach(function (item, index) {
            let row = `<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-price="${item['price']}" data-unit="${item['unit']}" data-id="${item['id']}" class="btn btn-outline-dark text-xxs px-2 py-1 addProduct  btn-sm m-0">Add</a></td>
                     </tr>`
        ...
        $('.addProduct').on('click', async function () {
            ...
            addModal(PId, PName, PUnit, PPrice)
        })
