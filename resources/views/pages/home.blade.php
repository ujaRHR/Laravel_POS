...
<nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="header01">
            ...
            <div><a class="btn mt-3 bg-gradient-danger" href="{{url('/user-login')}}">Start Sale</a></div>
        </div>
    </div>
</nav>
    ...
    <div class="container pt-2">
        <div class="row align-items-center mb-5">
            <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                ...
                <div class="d-flex flex-wrap"><a class="btn bg-gradient-danger me-2 mb-2 mb-sm-0"
                        href="{{url('/user-login')}}">Start Sale</a>
                    <a class="btn bg-gradient-danger mb-2 mb-sm-0" href="{{url('/user-login')}}">Login</a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                ...
                <p class="text-muted mb-5">Chittagong, Bangladesh 4200</p>
                <h4 class="fw-bold">Contact Us</h4>
                <p class="text-muted mb-1">hello@rhraju.com</p>
                <p class="text-muted mb-0">+880-1628****91</p>
            </div>
            <div class="col-12 col-lg-6 offset-lg-1">
                <form action="#">
                    <input class="form-control mb-3" type="text" id="name" placeholder="Name">
                    <input class="form-control mb-3" type="email" id="email" placeholder="E-mail">
                    <textarea class="form-control mb-3" id="message" name="message" cols="30" rows="10"
                        placeholder="Your Message..."></textarea>
                    <button class="btn bg-gradient-danger w-100" id="submit">Send Message</button>
                </form>
            </div>
        </div>
    </div>
...
<footer class="py-5 bg-light">
    ...
    <div class="mb-5"></div>
    <div class="container">
        <p class="text-center">All rights reserved © i-Shop POS 2024</p>
    </div>
</footer>
